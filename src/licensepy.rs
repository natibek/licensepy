...
impl DistType {
    pub fn get_metadata(self, python_version: &[i32; 3], recursive: bool, license_to_avoid: &Vec<String>) -> Metadata {
        match self {
...
pub fn parse_metadata(path: PathBuf, python_version: &[i32; 3], recursive: bool, license_to_avoid: &Vec<String>) -> Metadata {
